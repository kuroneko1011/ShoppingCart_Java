...
public class DispatcherFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            Properties siteMap
                    = (Properties) context.getAttribute("SITEMAP");
            //get resource name
            ...
            if (url != null) {
                ...
                //create an arraylist to store bookList from database
                ...
                if (currentBookList == null) {
                    //set bookList to session
                    session.setAttribute("BOOK", books);
                }
                RequestDispatcher rd = req.getRequestDispatcher(url);
                rd.forward(request, response);
            } else {
                url = MyApplicationConstants.ErrorFeatures.ERROR_PAGE_404;
