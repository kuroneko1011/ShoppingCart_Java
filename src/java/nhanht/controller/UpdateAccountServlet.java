...
public class UpdateAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean checkAdminBoolean = true;
        String url = MyApplicationConstants.ErrorFeatures.ERROR_PAGE;

        if (checkAdmin == null) {
            checkAdminBoolean = false;
        }
        ...
        try {
            ...
            session.setAttribute("ROLE", dao.getRole(currentUser));
            if (result) {
                url = "searchController" + "?btAction=Search"
